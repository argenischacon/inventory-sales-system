...
public record SaleResponseDTO(
        ...
        @Schema(description = "Timestamp when the sale occurred", example = "2023-10-15T10:30:00")
        LocalDateTime date,

        @Schema(description = "Auto-generated ticket or receipt number", example = "TKT-123456789")
        String ticketNumber,
        ...
        @Schema(description = "List of products sold in this transaction")
