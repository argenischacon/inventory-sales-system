...
public record ProductResponseDTO(
                ...
                @Schema(description = "Stock Keeping Unit", example = "SKU-1234") String sku,

                @Schema(description = "Name of the product", example = "Laptop") String name,

                @Schema(description = "Detailed description", example = "High-performance laptop") String description,

                @Schema(description = "Unit price of the product", example = "999.99") BigDecimal unitPrice,
                ...
                @Schema(description = "Category details") CategoryNestedDTO category,

                @Schema(description = "Supplier details") SupplierNestedDTO supplier) {
}
