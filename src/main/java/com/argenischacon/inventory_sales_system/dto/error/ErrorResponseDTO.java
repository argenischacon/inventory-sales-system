...
public record ErrorResponseDTO(
        ...
        @Schema(description = "Detailed error message", example = "Validation failed for object='categoryRequestDTO'. Error count: 1")
        String message,

        @Schema(description = "Path where the error occurred", example = "/api/v1/categories")
        String path,

        @Schema(description = "Map of specific validation errors if applicable")
