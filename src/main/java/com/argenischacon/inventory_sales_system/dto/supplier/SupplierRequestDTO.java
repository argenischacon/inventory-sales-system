...
public record SupplierRequestDTO(
        @Schema(description = "Supplier Tax ID/RUT", example = "J-123456789")
        ...
        @Schema(description = "Supplier email address", example = "contact@techsupplies.com")
        @NotBlank(message = "Email is mandatory")
        @Email(message = "Email should be valid")
        @Size(max = 100, message = "Email must not exceed 100 characters")
        String email,

        @Schema(description = "Supplier phone number", example = "+584141234567")
        @Size(max = 20, message = "Phone must not exceed 20 characters")
        String phone,

        @Schema(description = "Physical address of the supplier", example = "123 Main St, City")
